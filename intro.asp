...
<p>Back in the year 2000, thousands of ASP/VBScript developers were left alone in the woods by a very small team of MS developers who choose to build ASP.NET and kill off ASP and VBScript. ASP/VBScript were very popular web development and scripting technologies at that time. It was MicroSoft's first answer to another rapidly growing web technology and competitor: PHP and Apache servers. Most businesses preferred ASP to PHP back then. ASP scripts were running faster, integrated well with other MicroSoft products, had a rapidly growing community and supported (multi-threaded) COM-extensions. But above all, ASP/VBScript was very easy to learn, even for people like me, without a degree in computer science whatsoever. VBScript was a VISUAL scripting language after all.</p>

<p>PHP developers had more luck. Between 2000 and 2010 (about the same period of the rise and fall of ASP.NET and Windows Servers) a handful of PHP developer frameworks gained popularity amongst web developers (Zend, CakePHP, Symfony, Laravel, ...)</p>
...
<p>This book ain't a book really. It's an ASP script, using aspLite as its preferred framework. The easiest way to write a book about aspLite is using it while you're writing it.</p>

<h2>How does aspLite fit in?</h2>

<div class="alert alert-success"><p class="lead">24 years ago, classic ASP was about Request() and Response(). Ins and outs. Simply put.<br><br>Today, any server-side web framework is still about just that. <br><br>For everything else you can - in 2024 - rely on JavaScript frameworks. No more need for spaghetti-ASP or HTML server-controls.</p></div>
